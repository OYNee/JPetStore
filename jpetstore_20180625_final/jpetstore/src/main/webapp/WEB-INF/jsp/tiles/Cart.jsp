...
<table>
  <tr style="vertical-align:top">
        ...
        <table id="cart">
          ...
          <c:forEach var="cartItem" items="${cart.cartItemList.pageList}">
            <tr bgcolor="#FFFF88">
              ...
              <td style="text-align:center"><c:out value="${cartItem.inStock}" />(${ cartItem.preQty })</td>
              <td style="text-align:center">
                <input type="text" size="3" id="newQty"
          ...
          <tr bgcolor="#FFFF88">
            <td colspan="7" align="right">
              <c:if test="${ reject == 1 }">
                	<font color='red'>재고를 초과했습니다.</font><br/>
              </c:if>
      ...
      <c:if test="${cart.numberOfItems > 0}">
        ...
        <div style="text-align:center">
          <c:if test="${ reject == 1 }">
            ...
            <img border="0" src="../images/button_checkout.gif" alt="" onclick="check_qty();"/>
          </c:if>
          <c:if test="${ reject != 1 }">
    ...
    <td style="text-align:right;width:20%;">
      <c:if test="${!empty userSession.account.user_id}">
