...
public class Cart implements Serializable {
  ...
  public void addItem(Item item, boolean isInStock, int preQty) {
  ...
  //재고 얻기 추가
  public int getQuantityInStockByItemId(String itemId) {
	  CartItem cartItem = itemMap.get(itemId);
	  return cartItem.getPreQty();
  }
